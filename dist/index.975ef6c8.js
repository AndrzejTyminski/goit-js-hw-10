...
function searchCountry() {
    const countries1 = inputEl.value.trim();
    ...
    (0, _fetchCountries.fetchCountries)(countries1).then((countries)=>{
        renderResult(countries);
    }).catch(onError);
}
function renderResult(countries) {
    if (countries.length > 10) (0, _notiflixNotifyAio.Notify).info("Too many matches found. Please enter a more specific name.");
    if (countries.length < 10 && countries.length > 2) {
        dataOutputInfo("");
        let markupList = countries.map((country)=>createListCoutry(country)).join("");
...
createMurkup = (country)=>{
  ...
  <p class="coutry-text"><b>Languages:</b> ${Object.values(languages).join(", ")}</p>`;
};
dataOutputLi = (markup)=>{
...
},{"./css/styles.css":"1CY4s","notiflix/build/notiflix-notify-aio":"eXQLZ","./js/fetchCountries":"dKuy9","lodash.debounce":"3JP5n"}],"1CY4s":[function() {},{}],"eXQLZ":[function(require,module,exports) {
var global = arguments[3];
/*
